...
public class EvaluateService {
     ...
     */
    public void insertEvaluatorInfos(List<EvaluateValueInfo> evaluateValueInfos){
        evaluateValueMapper.insertEvaluatorInfos(evaluateValueInfos);
    }
    /**
     * 
    * @Title: insertEvaluatorInfo  
    * @Description: 单笔插入  
    * @param evaluateValueInfo       
    * @return void    
    * @author sw
    * @throws
     */
    public void insertEvaluatorInfo(EvaluateValueInfo evaluateValueInfo) {
    	evaluateValueMapper.insertEvaluatorInfo(evaluateValueInfo);
    }
